module.exports = {
  ...
  globIgnores: [
    ...
    "sw.js",
    "sw-src.js",
    "third_party/workbox/workbox-v7.0.0/*.dev.js",
    "third_party/workbox/workbox-v7.0.0/workbox-window.*",
    "third_party/workbox/workbox-v7.0.0/workbox-background-sync.prod.js",
    "third_party/workbox/workbox-v7.0.0/workbox-broadcast-update.prod.js",
    "third_party/workbox/workbox-v7.0.0/workbox-cacheable-response.prod.js",
    "third_party/workbox/workbox-v7.0.0/workbox-expiration.prod.js",
    "third_party/workbox/workbox-v7.0.0/workbox-navigation-preload.prod.js",
    "third_party/workbox/workbox-v7.0.0/workbox-offline-ga.prod.js",
    "third_party/workbox/workbox-v7.0.0/workbox-range-requests.prod.js",
    "third_party/workbox/workbox-v7.0.0/workbox-recipes.prod.js",
    "third_party/workbox/workbox-v7.0.0/workbox-streams.prod.js",
    ".gitignore",
    "node_modules/*",
    "node_modules/**",
