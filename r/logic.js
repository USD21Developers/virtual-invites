  ...
  if (eventNameEl && eventName) {
    ...
    if (eventObj.isDeleted === 1) {
      eventNameEl.innerHTML = `
        <a href="${url}" class="text-underline text-danger" target="_blank" rel="nofollow"><strike>${eventName}</strike></a>
      ...
      eventNameEl.innerHTML = `<a href="${url}" class="text-underline" target="_blank" rel="nofollow">${eventName}</a>`;
    }
  }
