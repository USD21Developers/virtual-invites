  ...
  if (eventNameEl && eventName) {
    ...
    if (eventObj.isDeleted === 1) {
      eventNameEl.innerHTML = `
        <a href="${url}" class="text-underline text-danger" target="_blank" rel="noopener noreferrer"><strike>${eventName}</strike></a>
      ...
      eventNameEl.innerHTML = `<a href="${url}" class="text-underline" target="_blank" rel="noopener noreferrer">${eventName}</a>`;
    }
  }
